module.exports = {
  ...
  OFFICE_CREATE_SUCCESS: "대여소 작성 성공",
  OFFICE_CREATE_FAIL: "대여소 작성 실패",
  OFFICE_READ_ALL_SUCCESS: "대여소 전체 조회 성공",
  OFFICE_READ_ALL_FAIL: "대여소 전체 조회 실패",
  OFFICE_READ_SUCCESS: "대여소 조회 성공",
  OFFICE_READ_FAIL: "대여소 조회 실패",
  OFFICE_UPDATE_SUCCESS: "대여소 수정 성공",
  OFFICE_UPDATE_FAIL: "대여소 수정 실패",
  OFFICE_DELETE_SUCCESS: "대여소 삭제 성공",
  OFFICE_DELETE_FAIL: "대여소 삭제 실패",
  ALREADY_ID: "존재하는 ID 입니다.",
  NO_USER: "존재하지 않는 유저 입니다.",
  NO_OFFICE: "존재하는 대여소 입니다.",
  MISS_MATCH_PW: "비밀번호가 일치하지 않습니다",
